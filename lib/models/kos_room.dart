...
extension RentalTypeExt on RentalType {
  ...
  String get priceLabel {
    switch (this) {
      ...
      case RentalType.monthly:
        return 'Harga per Bulan';
      case RentalType.yearly:
        return 'Harga per Tahun';
    }
  }
...
class KosRoom {
  ...
  final RoomTenantSummary? activeTenant;
  final String tenantDataStatus;
  ...
  factory KosRoom.fromJson(Map<String, dynamic> json) => KosRoom(
        ...
        rentalType:
            RentalTypeExt.fromDb(json['rental_type'] as String? ?? 'monthly'),
        facilities: ((json['facilities'] as List?) ?? const [])
            .map((e) => RoomFacility.fromJson(e as Map<String, dynamic>))
            .toList(),
        activeTenant: json['activeTenant'] is Map<String, dynamic>
            ? RoomTenantSummary.fromJson(
                json['activeTenant'] as Map<String, dynamic>,
              )
            : null,
        tenantDataStatus: json['tenantDataStatus'] as String? ?? 'none',
...
class RoomTenantSummary {
  const RoomTenantSummary({
  ...
  factory RoomTenantSummary.fromJson(Map<String, dynamic> json) =>
      RoomTenantSummary(
